...
$api->version('v1', function ($api) {
    $api->group(['prefix' => 'admin'], function ($api) {
        ...
        $api->get('item-menus/list', 'VCComponent\Laravel\Menu\Http\Controllers\Admin\Menu\ItemMenuController@getList');
        $api->resource('item-menus', 'VCComponent\Laravel\Menu\Http\Controllers\Admin\Menu\ItemMenuController');
    });
});
